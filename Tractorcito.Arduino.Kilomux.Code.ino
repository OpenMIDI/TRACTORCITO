...
#define NOTA_0_MIDI  2
#define NOTA_1_MIDI  120
#define NOTA_2_MIDI  121  
#define NOTA_3_MIDI  0
#define NOTA_4_MIDI  1
#define NOTA_5_MIDI  5
#define NOTA_6_MIDI  4
#define NOTA_7_MIDI  3
#define NOTA_8_MIDI  8
#define NOTA_9_MIDI  7
#define NOTA_10_MIDI 6
#define NOTA_11_MIDI 9
#define NOTA_12_MIDI 10
#define NOTA_13_MIDI 13
#define NOTA_14_MIDI 12
#define NOTA_15_MIDI 11
...
// AJUSTABLES SEGÚN APLICACIÓN
#define N_LED_MIDI_0 4
#define N_LED_MIDI_1 5
#define N_LED_MIDI_2 2
#define N_LED_MIDI_3 3
#define N_LED_MIDI_4 7
#define N_LED_MIDI_5 6
#define N_LED_MIDI_6 0
#define N_LED_MIDI_7 1
...
#define VELOCITY_LIM_TITILA 64                     // Limite de velocity en el MIDI INpara definir parpadeo - 0            - APAGADO
  ...
  #define PIN_BOTON_ACT_US     10
  #define PIN_LED_ACT_US       11
  ...
  switch(shift){
    case 0:
      switch (nota) {
        ...
        case CC_4_HW:  MIDI.sendControlChange(CC_4_MIDI, constrain(map(velocity[mux][nota],11,117,0,127),0,127), CANAL_MIDI_CC);  break;   
        ...
        case CC_11_HW:  MIDI.sendControlChange(CC_11_MIDI, constrain(map(velocity[mux][nota],10,116,127,0),0,127), CANAL_MIDI_CC);  break;    
        case CC_12_HW:  MIDI.sendControlChange(CC_12_MIDI, constrain(map(velocity[mux][nota],10,116,0,127),0,127), CANAL_MIDI_CC);  break;    
  ...
  switch(shift){
    case 0:                            // Página de CC stand-by
      switch (nota) {
        ...
        case CC_4_HW:  Serial.print("Numero de pote: "); Serial.print(CC_4_MIDI); Serial.print("  Valor: "); Serial.println(constrain(map(velocity[mux][nota],11,117,0,127),0,127)); break;
        ...
        case CC_11_HW:  Serial.print("Numero de pote: "); Serial.print(CC_11_MIDI); Serial.print("  Valor: "); Serial.println(constrain(map(velocity[mux][nota],10,116,127,0),0,127)); break;
        case CC_12_HW:  Serial.print("Numero de pote: "); Serial.print(CC_12_MIDI); Serial.print("  Valor: "); Serial.println(constrain(map(velocity[mux][nota],10,116,0,127),0,127)); break;
